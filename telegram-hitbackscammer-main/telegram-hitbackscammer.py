...
def menu():
    ...
    print("".rjust(2) + "7. (NEW!) Delete and send message - listening mode to delete and send mails")
    print("".rjust(2) + "8. Exit\n")
...
while check_config():    
    ...
    if sys.platform.startswith('win'):
        if choice == "1":        
            ...
            subprocess.run(["python", "deleteAndNotifyEmail.py"], check=True)
            foreground = False
        elif choice == "8":
            break
        else:
        ...
        if choice == "1":        
            ...
            subprocess.run(["python3", "deleteAndNotifyEmail.py"], check=True)
            foreground = False
        elif choice == "8":
            break
        else:
